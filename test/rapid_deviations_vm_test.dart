...
void main() {
  ...
  test(
    'Rapid many deviations stress route-switch hysteresis',
    () async {
      ...
      final routeA = List.generate(
        30,
        (i) => LatLng(12.9600, 77.5850 + i * 0.00005),
      );
      // Route B: vertical corridor (north-south) around lon 77.5865
      final routeB = List.generate(
        30,
        (i) => LatLng(12.9595 + i * 0.00005, 77.5865),
      );
