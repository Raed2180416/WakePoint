...
void main() {
  ...
  test(
    'Time-based alarm triggers after eligibility and ETA drops below threshold',
    () async {
      ...
      // In test mode, cooldown is bypassed, so multiple alarms may trigger if updates are fast.
      expect(
